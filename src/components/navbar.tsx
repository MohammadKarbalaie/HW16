...
export const NavBar: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 h-[710px]">
      ...
      <div id="Main" className={`${show ? "-translate-x-full" : "translate-x-0"} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-72   flex-col h-full`}>
        ...
        <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
          ...
          <button className="hover:delay-100 focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full ">
          <FaHome />
            <p className="text-base leading-4" onClick={onClickHome}>Home</p>
          </button>
          <Link to="/users" className="w-full">
          <button className="hover:delay-100 focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  items-center w-full  space-x-6">
          <FaUser />
          ...
          <button className="hover:delay-100 focus:outline-none flex justify-start items-center space-x-6 hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded  py-3 pl-4  w-full ">
          <FaRegFileAlt />
            <p className="text-base leading-4  ">Posts</p>
          </button>
          </Link>
          <button className="hover:delay-300 flex justify-start items-center space-x-6 hover:text-white focus:outline-none focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  w-full ">
          <FaRegFlag />
