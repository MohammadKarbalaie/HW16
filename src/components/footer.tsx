    ...
    return (
            ...
            <div className="w-full border-gray-300 border-t lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
                <div className="container mx-auto">
                    <div className="xl:flex flex-wrap justify-between xl:mt-14 mt-16 pb-6 pl-3 sm:pl-0 font-semibold">
                        <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0 text-lg">
                            <p className="text-gray-800">2024 The North. All Rights Reserved</p>
                        </div>
                        <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 lg:mb-0 xl:mb-0">
                            <ul className="xl:flex lg:flex md:flex sm:flex justify-between">
                                <li className="text-gray-800 hover:text-gray-500 text-md mb-4 sm:mb-0 hover:border-b delay-300">
